...
Public Class savings_transac
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CooperativeLendingSystem.savings_transac.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsavings_transac
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As savings_transac = New savings_transac()
        rpt.Site = Me.Site
        Return rpt
    End Function
