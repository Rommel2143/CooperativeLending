...
Public Class sharecappassbook
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CooperativeLendingSystem.sharecappassbook.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsharecappassbook
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As sharecappassbook = New sharecappassbook()
        rpt.Site = Me.Site
        Return rpt
    End Function
